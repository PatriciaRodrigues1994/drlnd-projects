...
Follow the instructions in `Continuous_Control_20_Agent.ipynb` to train the second version of the project! 

### Algorithm Used :

Deepmind’s publication “Continuous Control With Deep Reinforcement Learning” (Lillicrap et al, 2015), in which the Deep Deterministic Policy Gradients (DDPG) is present
...
The Ornstein-Uhlenbeck Process generates noise that is correlated with the previous noise, as to prevent the noise from canceling out or “freezing” the overall dynamics.

### Ideas for Future Work :
 Use algorithms like PPO, A3C, and D4PG that use multiple (non-interacting, parallel) copies of the same agent to distribute the task of gathering experience to get better resuts on this task.
